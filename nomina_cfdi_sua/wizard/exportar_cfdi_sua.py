            ...
            for rec in i_nomina:
                ...
                if self.tipo_exp_idse == '0': #Alta / Reingreso
                   if rec.tipo_de_incidencia=='Reingreso' or rec.tipo_de_incidencia=='Alta':
                    ...
                    file_text.append(data0 + (data1)+(data3)+(data5)+(data6)+(data7)+(data8)+(data10)+(data11)+(data12)+(data13)+(data20))
                ...
                if self.tipo_exp_idse == '1': #Baja
                   if rec.tipo_de_incidencia=='Baja':
                    ...
                    file_text.append(data0 + (data1)+(data2)+(data3)+(data4)+(data5)+(data7)+(data12))
                ...
                if self.tipo_exp_idse == '2': #Cambio salario
                   if rec.tipo_de_incidencia=='Cambio salario':
                    ...
                    file_text.append(data0 + (data1)+(data2)+(data3)+(data4)+(data5)+(data6)+(data8)+(data9)+(data10)+(data16))
